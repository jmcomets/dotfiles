...
void Timer::start()
{
    ...
    {
        throw std::logic_error("Cannot start an already started timer");
    }
}
...
void Timer::stop()
{
    ...
    {
        throw std::logic_error("Cannot stop a timer which isn't started");
    }
}
...
void Timer::pause()
{
    ...
    {
        throw std::logic_error("Cannot pause a stopped timer");
    }
}
...
void Timer::unpause()
{
    ...
    {
        throw std::logic_error("Cannot unpause an unpaused timer");
    }
}
